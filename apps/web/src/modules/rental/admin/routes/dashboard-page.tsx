...
import {
  ...
  useComplaints,
  type ComplaintRow,
} from '@rental-admin/features/complaints/api'
import { ComplaintDetailDialog } from '@rental-admin/features/complaints/complaint-detail-dialog'
import {
  dateRangeError,
...
} from '@rental-admin/features/reporting/api'
      ...
      <PageHeader
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            ...
            <Button type="button" variant="outline" size="sm" asChild>
              <Link to="/app/rental/allotments">
                <Handshake aria-hidden="true" />
                New allotment
              </Link>
            </Button>
            <Button type="button" variant="outline" size="sm" asChild>
              <Link to="/app/rental/billing">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between gap-2">
            ...
            <Button type="button" variant="ghost" size="sm" asChild>
              <Link to="/app/rental/billing">View all</Link>
            </Button>
          </div>
          {loading ? (
        ...
        <Card className="py-4">
          <CardHeader className="px-4 pb-2">
            <div className="flex items-center justify-between gap-2">
              ...
              <Button type="button" variant="ghost" size="sm" asChild>
                <Link to="/app/rental/audit">Audit log</Link>
              </Button>
            </div>
          </CardHeader>
          <CardContent className="px-4">

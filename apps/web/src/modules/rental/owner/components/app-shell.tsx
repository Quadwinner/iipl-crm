...
import { useOwnerReminders } from '@rental-owner/features/notifications/api'
import { cn } from '@rental-owner/lib/utils'

const NAV_ITEMS = [
  { to: '/app/rental/home', label: 'Home' },
  { to: '/app/rental/lease', label: 'My lease' },
  { to: '/app/rental/invoices', label: 'Invoices' },
  { to: '/app/rental/reminders', label: 'Reminders' },
  { to: '/app/rental/receipts', label: 'Receipts' },
  { to: '/app/rental/complaints', label: 'Complaints' },
  { to: '/app/rental/documents', label: 'Documents' },
  { to: '/app/rental/profile', label: 'Profile' },
] as const
        ...
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Button type="button" variant="outline" size="sm" asChild>
              <Link to="/app/rental/reminders" aria-label={`Reminders${reminderCount ? `, ${reminderCount}` : ''}`}>
